...
local function buildEnergyPanel(parent)
  ...
  y = addColorField(parent, "Background", function() return StupidComboEnergyDB.energyBg end, function(c) StupidComboEnergyDB.energyBg = c end, y)
...
local function buildComboPanel(parent)
  ...
  y = addCycleField(parent, "Separator Style", {"gap","border"}, function() return StupidComboEnergyDB.cpSeparatorStyle end, function(v) StupidComboEnergyDB.cpSeparatorStyle = v end, y)
  y = addNumberField(parent, "Segment Gap (gap style)", function() return StupidComboEnergyDB.cpGap end, function(v) StupidComboEnergyDB.cpGap = v end, y)
  y = addNumberField(parent, "Separator Width (border style)", function() return StupidComboEnergyDB.cpSeparatorWidth end, function(v) StupidComboEnergyDB.cpSeparatorWidth = v end, y)
